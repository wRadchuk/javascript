...
addCode(`Оператор сложения и унарный оператор + перед строкой  (+'${letC}' + ${letA}) = ` + (+letC + letA))
...
addText(`Ну вот и всё что следует знать об операторах для начала. Дальше в коде возможно разберём и другие операторы
На этом тема закрыта и мы двигаемся дальше.`)
