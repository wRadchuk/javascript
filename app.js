...
а оператор равно вернет в этом случаи правду, так как он игнорирует тип данных. Так же существуют арифметические и бинарные операнды,
но их мы рассматривать не будем. При желании это легко гуглится и в принципе в них довольно легко разобраться. Возможно ниже в коде
будет приведен операнд инкремент и декремент, ну и мы использовали унарный операнд + для приведения строки в число.`)
addText(``)
addText(`Пожалуй финалом темы операндов и последним о чем стоит поговорить - будут логические операнды: И - если оба правда, то
